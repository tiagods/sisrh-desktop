...
import com.plkrhone.sisrh.SisrhspringbootApplication;
...
import com.plkrhone.sisrh.view.Menu;
...
public class LoginController implements Initializable{
	...
	private void logon() {
		...
		if (cbNome.getValue() == null) {
			...
			try{
				Usuario usuario = usuarios.findByLoginAndSenha(cbNome.getValue().getLogin(), txSenha.getText().trim());
				UsuarioLogado.getInstance().setUsuario(usuario);
				SisrhspringbootApplication.showView(Menu.class);
				login.close();
