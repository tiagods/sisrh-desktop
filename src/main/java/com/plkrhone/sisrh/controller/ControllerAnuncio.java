...
*/
            try {
                ...
                stage.setOnHiding(e -> {
                    try {
                        ...
                        alert(AlertType.ERROR,"Erro","","Falha ao carregar formulario!",ex,true);
                    } finally {
                        close();
                    }
                });
            ...
            alert(AlertType.WARNING,"Alerta!","","Salve antes de avançar!");
        }
    }
        ...
        try {
            ...
            stage.setOnHiding(e -> {
                try {
                    ...
                    new ComboBoxAutoCompleteUtil<>(cbVaga1Cargo);
                    if(ca!=null){
                        cbVaga1Cargo.getSelectionModel().select(ca);
                    }
                    else{
                        cbVaga1Cargo.getSelectionModel().select(cargo);
                    }
                } catch (Exception ex) {
