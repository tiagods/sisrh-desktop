...
public abstract class AbstractSupportView extends AbstractFxmlView {
   ...
   * <p>
   * {@link de.felixroske.jfxsupport.AbstractFxmlView} is a stripped down version of <a href=
   ...
   *
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(AbstractSupportView .class);
  ...
  private FXMLView getFXMLAnnotation() {
    final Class<? extends de.felixroske.jfxsupport.AbstractFxmlView> theClass = this.getClass();
